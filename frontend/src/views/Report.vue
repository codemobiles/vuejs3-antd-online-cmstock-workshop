    ...
    <a-col :span="24" :md="8" class="tw-h-full">
      ...
      >
        <a-col :span="24">
          <PieChart
            :data="pieData"
            class="tw-h-full md:tw-max-h-[45vh] tw-overflow-auto"
        /></a-col>
        <a-col :span="24">
          <BarChart
            :data="barData"
...
export default defineComponent({
  ...
  setup() {
    ...
    const shuffleData = () => {
      const array = [lineData, barData, pieData];
      for (const [index, dataset] of array.entries()) {
